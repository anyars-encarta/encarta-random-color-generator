...
<div align="center">
 ...
 <!-- LOGO -->
  ...
  <img src="./src/assets/color-generator.png" alt="logo" width="160"  height="auto" />
  <br/>

<!-- MAIN HEADING -->

  <h3><b>Encarta Random Color Generator</b></h3>
...
<!-- INTRO -->
# 📖 Encarta Random Color Generator<a name="about-project"></a>
...
> - Generate and change the background color using HEX
> - Generate and change the background color using RGB
...
> 
```sh
cd encarta-random-color-generator
https://github.com/anyars-encarta/encarta-random-color-generator.git
```
